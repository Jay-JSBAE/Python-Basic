...
print(all([1,2,3])) # and
print(any([1,2,0])) # 하나라도 true면 true => or 개념
print()
...
print(list(filter(conv_pos, [1, -3, 2, 0, -5, 6]))) # 예로 평균 90점 이상 이런거 할때
...
print(round(5.6)) #두번쨰 인자를 넣지 않으면 첫째 자리에서 반올림
print()
